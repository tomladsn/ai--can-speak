...
class Workspace {
     ...
     *     })
     */
    getSsoProviderAdmin(request, requestOptions) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.ElevenLabsEnvironment.Production, "admin/n8enylacgd/sso-provider"),
                method: "GET",
                headers: {
