...
const Client_14 = require("./api/resources/workspace/client/Client");
const Client_15 = require("./api/resources/models/client/Client");
const Client_16 = require("./api/resources/audioNative/client/Client");
const Client_17 = require("./api/resources/usage/client/Client");
const Client_18 = require("./api/resources/pronunciationDictionary/client/Client");
class ElevenLabsClient {
    ...
    get workspace() {
        var _a;
        return ((_a = this._workspace) !== null && _a !== void 0 ? _a : (this._workspace = new Client_14.Workspace(this._options)));
    }
    get models() {
        var _a;
        return ((_a = this._models) !== null && _a !== void 0 ? _a : (this._models = new Client_15.Models(this._options)));
    }
    get audioNative() {
        var _a;
        return ((_a = this._audioNative) !== null && _a !== void 0 ? _a : (this._audioNative = new Client_16.AudioNative(this._options)));
    }
    get usage() {
        var _a;
        return ((_a = this._usage) !== null && _a !== void 0 ? _a : (this._usage = new Client_17.Usage(this._options)));
    }
    get pronunciationDictionary() {
        var _a;
        return ((_a = this._pronunciationDictionary) !== null && _a !== void 0 ? _a : (this._pronunciationDictionary = new Client_18.PronunciationDictionary(this._options)));
    }
}
